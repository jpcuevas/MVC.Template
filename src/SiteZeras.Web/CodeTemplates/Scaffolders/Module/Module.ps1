...
$DataProject = "SiteZeras.Data"
$TestsProject = "SiteZeras.Tests"
$RazorViewProject = "SiteZeras.Web"
$ObjectsProject = "SiteZeras.Objects"
$ServiceProject = "SiteZeras.Services"
$ValidatorProject = "SiteZeras.Validators"
$ControllerProject = "SiteZeras.Controllers"
