using SiteZeras.Controllers.Administration;
using NUnit.Framework;
using System;
using System.Web.Mvc;
using System.Web.Routing;

namespace SiteZeras.Tests.Unit.Controllers.Administration
{
    [TestFixture]
    public class AdministrationAreaRegistrationTests
    {
        ...
        public void RegisterArea_RegistersAdministrationMultilingualRoute()
        {
            ...
            CollectionAssert.AreEqual(new[] { "SiteZeras.Controllers.Administration" }, actual.DataTokens["Namespaces"] as String[]);
